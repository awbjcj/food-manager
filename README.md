...
| `OPERATOR_TELEGRAM_IDS`    | No                   | `ALLOWED_TELEGRAM_USER_ID`  | Comma-separated IDs allowed to use the private operator bot; admin authority is deployment-controlled, not a customer role                                                                 |
...
| `DEEPSEEK_MODEL`           | No                   | `deepseek-v4-pro`           | DeepSeek model to use for text and search tasks; this documented route serves V4.1 Flash until V4.1 Pro launches                                                                            |
