...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "nl.shopping.added": {
        ...
        "zh": "已向购物清单添加 {n} 项。",
        "fr": "{n} article(s) ajouté(s) à votre liste de courses.",
        "es": "Se añadieron {n} artículo(s) a tu lista de compras.",
    },
    "nl.shopping.already": {
        "en": "Those item(s) are already on your shopping list.",
        "zh": "这些项目已在购物清单中。",
        "fr": "Ces articles figurent déjà sur votre liste de courses.",
        "es": "Esos artículos ya están en tu lista de compras.",
    },
    "nl.shopping.removed": {
        "en": "Removed {n} bought item(s) from your shopping list.",
        "zh": "已从购物清单移除 {n} 个已购买项目。",
        "fr": "{n} article(s) acheté(s) retiré(s) de votre liste de courses.",
        "es": "Se eliminaron {n} artículo(s) comprados de tu lista.",
    },
    "nl.shopping.not_found": {
        "en": "I couldn't find those items on your shopping list.",
        "zh": "我在购物清单中找不到这些项目。",
        "fr": "Je n’ai pas trouvé ces articles dans votre liste de courses.",
        "es": "No encontré esos artículos en tu lista de compras.",
    },
    "nl.shopping.invalid": {
        "en": "Tell me which shopping-list items to add or remove.",
        "zh": "请告诉我要添加或移除哪些购物清单项目。",
        "fr": "Indiquez les articles à ajouter ou retirer de la liste de courses.",
        "es": "Dime qué artículos añadir o quitar de la lista de compras.",
    },
