...
const english = {
  ...
  'plan.unlimitedPlan': 'Unlimited plan',
  ...
  'usage.ariaUnlimited': '{label}: {used} used, unlimited',
  ...
  'plan.unlimitedManaged': 'Your unlimited plan is managed by the operator. No purchase is needed.',
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  ...
  zh: {
    ...
    'usage.unlimited': '无限',
    'usage.ariaUnlimited': '{label}：已使用 {used}，无限额度',
    ...
    'plan.unlimitedManaged': '你的无限套餐由运营者管理，无需购买。',
    'plan.current': '当前套餐',
    'plan.included': '已包含',
    'plan.manage': '管理套餐',
  ...
  fr: {
    ...
    'plan.unlimitedPlan': 'Forfait illimité',
    ...
    'usage.ariaUnlimited': '{label} : {used} utilisés, illimité',
    ...
    'plan.unlimitedManaged': 'Votre forfait illimité est géré par l’opérateur. Aucun achat n’est nécessaire.',
  ...
  es: {
    ...
    'plan.unlimitedPlan': 'Plan ilimitado',
    ...
    'usage.ariaUnlimited': '{label}: {used} usados, ilimitado',
    ...
    'plan.unlimitedManaged': 'Tu plan ilimitado lo administra el operador. No necesitas comprar nada.',
